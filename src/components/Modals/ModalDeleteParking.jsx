    ...
    if (confirmText === "Eliminar estacionamiento") {
      try {
        const response = await fetch(
          `https://sistema-estacionamiento-backend-production.up.railway.app/api/estacionamientos/${estacionamiento.id}`,
          { method: "DELETE" }
        );
        if (response.ok) {
  ...
  return (
    <div>
      <button
        ...
        onClick={() => handleEditClick(estacionamiento.id)}
      >
        Editar
      </button>
      <button
            ...
            <div className="modal-content">
              ...
              <div className="modal-body">
                ...
                <input
                  ...
                  placeholder="Eliminar estacionamiento"
                />
              </div>
